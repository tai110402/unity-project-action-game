    ...
    public static void InitializeChallengeQuestsDefaultValue()
    {
        _questData = new QuestData()
        {
            Quests = new Quest[] { new Quest() {Id = "001" , State = "doing", Type = "moving", Position = new Vector3(11, 0.74f, 16),Title = "Quest 1", Content = "C-Di den nga 3 dau tien"},
                    ...
                    new Quest() {Id = "219" , State = "lock", Type = "attack", Position = new Vector3(-8.3f, 0.36f, -2.36f), Progress = 0, Condition = 1, Title = "Quest 4", Content = "C-Danh bai quai vat 7 xuat hien"},
                    ...
                    new Quest() {Id = "229" , State = "lock", Type = "attack", Position = new Vector3(-9.84f, 41.07f, 104.68f), Progress = 0, Condition = 4, Title = "Quest 4", Content = "C-Danh bai quai vat canh cong 11 xuat hien"},
